...
__C.general.training_image_list_file = '/home/bian/work/Medical-Detection3d-Toolkit/data/dataset/pelvic/train.csv'
...
__C.general.save_dir = '/home/bian/work/Medical-Detection3d-Toolkit/data/models/pelvic/'
...
__C.landmark_loss.focal_obj_alpha = [0.75] * 15  # class balancing weight for focal loss
